...
//additional links: https://pkg.go.dev/golang.org/x/tools/cmd/stringer

//learn: https://pkg.go.dev/golang.org/x/tools/cmd/stringer
...
// In such cases the stringer tool can be used in conjunction with go:generate to automate the process. See this post for a longer explanation.
